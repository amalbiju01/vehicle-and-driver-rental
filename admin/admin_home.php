            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left:-10%">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item">
                     <a class="nav-link" href="./view_user.php">ViewUser</a>

                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="./add_vehicle.php">AddVehicles</a>
                     </li>
                     <li class="nav-item">        
                     <a class="nav-link" href="./view_vehicle.php">ViewVehicle</a>
                  </li>
                  <!-- <li class="nav-item">
                        <a class="nav-link" href="./add_driver.php">AddDriver</a>
                     </li> -->
                     <li class="nav-item">
                        <a class="nav-link" href="view_driver.php">ViewDriver</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="./view_booking.php">VehicleBooking</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="./view_bookingdriver.php">DriverBooking</a>
                     </li>
                     <li class="nav-item">
                     ...
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <div class="banner_taital_main">
                              <h1 class="banner_taital">KRY VAHAN <br><span style="color: #fe5b29;">For You</span></h1>
                              <p class="banner_text">"Ride in Style: Luxury Car Rentals for Every Occasion"</p>
                              <div class="btn_main">
                        ...
                        <div class="carousel-item">
                           <div class="banner_taital_main">
                              <h1 class="banner_taital">Rent <br><span style="color: #fe5b29;">For You</span></h1>
                              <p class="banner_text">"Drive Your Dreams - Rent the Perfect Vehicle Today!"</p>
                              <div class="btn_main">
                                 <!-- <div class="contact_bt"><a href="#">Read More</a></div> -->
                                 <!-- <div class="contact_bt active"><a href="#">Contact Us</a></div> -->
                              </div>
                        ...
                        <div class="carousel-item">
                           <div class="banner_taital_main">
                              <h1 class="banner_taital">Ride <br><span style="color: #fe5b29;">For You</span></h1>
                              <p class="banner_text">"Find Your Ride - Explore Our Fleet and Hit the Road in Style!"</p>
                              <div class="btn_main">
                                 <!-- <div class="contact_bt"><a href="#">Read More</a></div> -->
                                 <!-- <div class="contact_bt active"><a href="#">Contact Us</a></div> -->
                              </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6"> 
                     <div class="about_taital_box">
                        ...
                        <p class="about_text">We are offering a wide selection of premium cars for any occasion. Our fleet includes luxury vehicles from top brands, ensuring that you can travel in style and comfort 
                           we understand that convenience is key, which is why we offer easy online booking and flexible pickup and drop-off options. Whether you need a car for a few hours or an extended trip, we are here to accommodate your requirements. </p>
            ...
            <div class="choose_section_2">
               <div class="row">
                  <div class="col-sm-4">
                     ...
                     <p class="ipsum_text">Ensuring the safety and security of our customers is a top priority at our website. We take several measures to safeguard your personal and financial information, as well as to ensure the reliability and safety of our vehicles. </p>
                  </div>
                  <div class="col-sm-4">
                     <div class="icon_1"><img src="../images/icon-2.png"></div>
                     <h4 class="safety_text">Online Booking</h4>
                     <p class="ipsum_text">Our website uses industry-standard encryption and secure payment processing to protect your personal and financial data when making reservations.</p>
                  </div>
                  <div class="col-sm-4">
                     <div class="icon_1"><img src="../images/icon-3.png"></div>
                     <h4 class="safety_text">Best Customer service </h4>
                     <p class="ipsum_text">Our customer support team is available around the clock to assist with any concerns or emergencies during the rental period. </p>
                  </div>
               </div>
            </div>
         </div>
