...
$query = "SELECT *
FROM `vehicle`
JOIN `booking` ON `vehicle`.`bid` = `booking`.`bid`
WHERE `vehicle`.`status` = 'booked' AND `booking`.`uid`='$uid'
";
...
.main-back {
  background: rgb(169, 184, 136) !important;
  display: flex;
  position: absolute;
  width: 100%;
  height: 100vh;
...
<body>
  ...
  <?php
  echo "haaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
  echo $query;
  while ($row = mysqli_fetch_array($result)) {
        $id = $row['0'];
    ?>
  <div class="main-back">
    <div class="container m-auto  p-5 bod-3" style="background-color:wheat;">
      <div class="row">
        <!-- CARD FORM -->
        <div class="col-lg-8 col-md-12">
          <form method="post">
            ...
            <div class="action flex-center">
              <button type="submit" name="pay" class="b-main-color pointer">
                Pay Now
              </button>
            </div>
...
$result = mysqli_query($con, $query);
$que = "UPDATE booking  SET `status`='paid' WHERE `bookid`='$bookid'";
echo $que;
          ...
          <div class="purchase-section flex-fill flex-vertical">
            ...
            <ul class="purchase-props">
              ...
              <li class="flex-between">
                ...
                <strong><?php echo $row['regnum']; ?></strong>
              </li>
              <li class="flex-between">
                <span>Start Date</span>
                <strong><?php echo $row['s_date']; ?></strong>
              </li>
              <li class="flex-between">
                <span>End Date</span>
                <strong> <?php echo $row['e_date']; ?></strong>
              </li>
            </ul>
          </div>
