        ...
        <div class="container">
            <div class="feedback">
                ...
                <div class="form-group text-center">
                    <textarea name="review" class="md-textarea form-control" placeholder="Enter Feedback"
                        id="exampleFormControlTextarea6" cols="30" rows="5" required></textarea>
                    <input type="submit" name="feed" class="btn btn-success mt-3"><br>
                    <a href="./user_home.php" class="btn btn-secondary mt-2">Go Back</a>
                </div>
            </div>
        </div>
    </form>
    ...
    <script>
        $(document).ready(function () {
            $('form').submit(function (event) {
                const selectedRating = $('input[name="rating"]:checked');
...
if (isset($_REQUEST['feed'])) {
    ...
    $qry = "SELECT * FROM `feedback` WHERE `uid` = '$uid' and bid='$id'";
	// echo $qry;
    ...
    $sql = "INSERT INTO `feedback` (`uid`, `rating`, `text`,`bid`)
    VALUES ('$uid', '$rating', '$review','$id')";
